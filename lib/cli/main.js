...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `recryptcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ recryptcore-node add wallet-service');
      console.log('    $ recryptcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ recryptcore-node remove wallet-service');
      console.log('    $ recryptcore-node remove insight-api');
      console.log();
    });
